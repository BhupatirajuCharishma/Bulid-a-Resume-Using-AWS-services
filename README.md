...
Result:
Your resume becomes accessible using an S3 website URL.
...
Result:
Only authorized users can deploy or modify the website.
...
Result:
Users access the website from the nearest CloudFront edge location.
...
Result:
Your resume opens using a custom domain name.
